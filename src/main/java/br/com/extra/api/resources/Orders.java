...
public class Orders extends CoreAPIImpl implements OrdersResource {
     ...
     *
     * @param orderId Número do pedido
    ...
    /**
     * Método responsável por retornar uma lista com os pedidos parcialmente enviados.
     *
     * @param offset Parâmetro utilizado para limitar a quantidade de registros
     *               trazidos por página.
     * @param limit  Parâmetro utilizado para limitar a quantidade de registros
     ...
     *
     * @param orderId           Número do pedido
     * @param orderDateAdjusted Data de atualização
     * @param reason            Motivo de alteração na entrega do item
     * @param originDeliveryID  Id de entrega do pedido para o lojista
     * @return
     */
     ...
     *
     * @param orderId         Número do pedido
     * @param orderItemIdList Número do item do pedido
     * @param reason          Motivo de cancelamento do item
     * @return
     */
     ...
     *
     * @param orderId Número do pedido
     * @param reason  Motivo do cancelamento do pedido
     * @return
     */
    ...
    /**
     * Método responsável por registrar uma nova operação de tracking para o Item do Pedido informado.
     *
     * @param orderId     número do pedido
     * @param orderItemId número do item do pedido
     * @param tracking    tracking do item
     * @return
     */
    public String updateTracking(String orderId, String orderItemId, Map<String, Object> tracking) {
        // TODO

        setResource("/orders/" + orderId + "/ordersItems/" + orderItemId + "/trackings");
